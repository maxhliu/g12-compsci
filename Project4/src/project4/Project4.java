...
public class Project4 {
    ...
    public static void main(String[] args) {
        ...
        //since i am using a scanner for input, it is easier to create an alternate scanner of an already entered cube for someone who wants to use the default cube
...
//        This is the way the cube has been set up. The origin of the net is the top, and the other sides are folded outwards.
        ...
        if (s.nextInt() == 0) {
            //read from the pre-recorded cube
            s = sp;
        } else {
...
//        read the last face
        ...
        //make sure that the scanner is reading from the keyboard now
        if (s == sp) {
            s = new Scanner(System.in);
            Cube.print();
        }

        System.out.println("Press 1 to solve the edges and 2 to solve the corners");
